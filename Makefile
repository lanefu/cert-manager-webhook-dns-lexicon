...
_test/kubebuilder:
	curl -fsSL https://go.kubebuilder.io/test-tools/$(KUBE_VERSION)/$(OS)/amd64 -o kubebuilder-tools.tar.gz
...
rendered-manifest.yaml:
	helm template \
        ...
        deploy/cert-manager-dns-lexicon-webhook > "$(OUT)/rendered-manifest.yaml"
